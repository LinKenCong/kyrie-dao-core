...
const deployERC6551Account: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
...
export default deployERC6551Account;
deployERC6551Account.tags = ["all", "ERC6551Account"];
